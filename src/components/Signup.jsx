...
const handleOnSubmit = (e)=> {
  ...
  return (
    <>
<Button bgColor="#183962" color="white" w="200px" onClick={onOpen}>{name? name: "Sign Up For Free"}</Button>
          ...
          <Input
           w="70%"
            m="auto"
             ...
             {!auth? <Input type="submit" value="SignUp" w="30%" m="auto" ml="20%" bgColor="#3182ce" color="white"/> 
